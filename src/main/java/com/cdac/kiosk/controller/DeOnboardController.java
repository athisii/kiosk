...
public class DeOnboardController extends AbstractBaseController {
    ...
    private void saveChanges() {
        try {
            var updateOnboardingReqDto = new UpdateOnboardingReqDto(App.getPno(), PropertyFile.getProperty(PropertyName.DEVICE_SERIAL_NO), "3", PropertyFile.getProperty(PropertyName.HARDWARE_ID), PropertyFile.getProperty(PropertyName.KIOSK_ID), "OFF");
            ...
            mafisUrlTextField.setText("https://test.indiannavy.mil");
            kioskUrlTextField.setText("https://test.indiannavy.mil");
            ...
            PropertyFile.changePropertyValue(PropertyName.KIOSK_URL, kioskUrlTextField.getText());
            saveIpaddressToFile();
