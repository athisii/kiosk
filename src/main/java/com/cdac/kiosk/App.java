package com.cdac.kiosk;


import com.cdac.kiosk.controller.AbstractBaseController;
import com.cdac.kiosk.dto.OnboardingUnitDetail;
import com.cdac.kiosk.logging.ApplicationLog;
import com.cdac.kiosk.util.DisplayUtil;
...
public final class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        scene = new Scene(loadFXML("main"), DisplayUtil.SCREEN_WIDTH, DisplayUtil.SCREEN_HEIGHT);
